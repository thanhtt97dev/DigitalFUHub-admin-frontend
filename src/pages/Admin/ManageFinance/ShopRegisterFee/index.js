...
import { Card, Table, Button, Form, Input, DatePicker, Row, Col, Space } from "antd";
import locale from 'antd/es/date-picker/locale/vi_VN';
import { getShopRegisterFees } from '~/api/shopRegisterFee'
...
import styles from '../BusinessFee/BusinessFee.module.scss';
import ModalAddNewShopRegisterFee from "~/components/Modals/ModalAddNewShopRegisterFee";
...
function ShopRegisterFee() {

    const columns = [
        {
            title: 'Id',
            dataIndex: 'shopRegisterFeeId',
            width: '5%',
        },
        {
        ...
        {
            title: 'Tổng số shop đã áp dụng',
            dataIndex: 'totalShopUsed',
            width: '15%',
        },
    ...
    const getBusinessFeeWithCondition = () => {
        getShopRegisterFees(searchData)
            .then((res) => {
        ...
        <>
            <Spinning spinning={loading}>
                <Card>
                    ...
                    <ModalAddNewShopRegisterFee callBack={getBusinessFeeWithCondition} />
                </Card>
...
export default ShopRegisterFee;